...
import java.util.List;
    ...
    public static void GenerateMaze(Graphics g)  {
        ...
        // 'W' represents walls, 'P' represents paths, 'S' is the start, and 'E' is the endpoint, 'R' is the solved route
    ...
    public static class MazeSolver {
        ...
        public static boolean dfs(char[][] maze, int x, int y, Graphics g)  {
        ...
        public static void solveMaze(char[][] maze, Graphics g) {
